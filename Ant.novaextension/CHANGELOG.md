...
- Adds an issue if the build fails

### Changed

- Logging to console based on info or error
- Changed placeholder text for sidebar

### Fixed

- Shows placeholder if a project does not contain an build.xml
